    ...
    <div class="flex justify-center items-center h-screen">
        <div class="w-full max-w-md p-6 bg-white rounded-lg shadow-md">
            ...
            <div v-if="cart.length > 0">
                ...
                <button @click="placeOrder" class="w-full py-2 px-4 rounded-md transition-colors duration-300"
                ...
                <p v-if="!isAuthorized" @click="redirectToRegister"
                    class="text-center text-red-500 mt-2 cursor-pointer hover:underline">
                    Для оформления заказа необходимо авторизоваться.
                </p>
                <p v-if="isAuthorized && (!user.fullName || !user.phoneNumber)" @click="redirectToProfile"
                    class="text-center text-red-500 mt-2 cursor-pointer hover:underline">
